...
$(function () {
    ...
    $.supersized({
        ...
        slides: [    // 幻灯片影像
                                 { image: '/Content/image/login_2.jpg' },
                                 { image: '/Content/image/login.jpg' }
                ...
                $.ajax({
                    ...
                    success: function (data, response, status) {
                        ...
                        if (data == 'T') {
                            ...
                            //alert("Y");
                            window.location.href = "/mainform/Index";
                           // window.location('@Url.Action("mainform", "index")');
                        }
