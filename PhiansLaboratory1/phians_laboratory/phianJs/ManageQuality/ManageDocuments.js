...
function File_type() {
    $('#File_type').tree({
        url: "/ManageQuality/LoadPageTree?id=4f8ac272-98b2-4b3f-b4d0-13b3f8e9e04b&Parent_id=8C20E217-5DC9-4B11-83BC-0325B47F7807",
        method: 'post',
        required: true,
        //title: '部门',
        fit: true,
        ...
        onBeforeExpand: function (node, param) {
            $('#File_type').tree('options').url = "/ManageQuality/LoadPageTree?id=4f8ac272-98b2-4b3f-b4d0-13b3f8e9e04b&Parent_id=" + node.id;
        },
        onSelect: function () {
            treeDatagrid();
        }
...
function Environmental_managementread() {
    ...
    if (selectRow) {
        $("#ShowOffice").prop("href", WordUrlSpit[0] + '?id=' + selectRow.id + '&Operation_Type=3&pageName=FileManagement' + WordUrlSpit[1]);
