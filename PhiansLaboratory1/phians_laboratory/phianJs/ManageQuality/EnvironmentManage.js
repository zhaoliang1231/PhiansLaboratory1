...
function Environmental_management_alterfile() {
    ...
    $('#FileType').textbox('setValue', selectRow.text);//重新赋值文件类型文本框的值
};
...
function Environmental_managementread() {
    ...
    if (selectRow) {
        $("#ShowOffice").prop("href", WordUrlSpit[0] + '?id=' + selectRow.id + '&Operation_Type=1&pageName=FileManagement' + WordUrlSpit[1]);
