...
(function (a) {
    ...
    a.supersized = function (b) {
        ...
        d.init = function () {
            ...
            if (d.options.performance == 3) { d.$el.addClass("speed") }
            else {
            ...
            } if (d.options.slides.length > 1)
            {
                if (d.options.slides.length > 2)
                {
                    ...
                    var g = (d.options.slides[loadPrev].url) ? "href='" + d.options.slides[loadPrev].url + "'" : ""; var q = a('<img src="' + d.options.slides[loadPrev].image + '"/>');
            ...
            if (d.options.slides.length > 1)
            {
                ...
                var e = a('<img src="' + d.options.slides[loadNext].image + '"/>'); var p = d.el + " li:eq(" + loadNext + ")"; e.appendTo(p).wrap("<a " + g + o + "></a>").parent().parent().addClass("image-loading"); e.load(function () { a(this).data("origWidth", a(this).width()).data("origHeight", a(this).height()); d.resizeNow() })
            ...
            if (d.options.keyboard_nav)
            {
                a(document.documentElement).keyup(function (e) {
                    ...
                    { clearInterval(vars.slideshow_interval); d.prevSlide() }
                        ...
                        if ((e.keyCode == 39) || (e.keyCode == 38)) { clearInterval(vars.slideshow_interval); d.nextSlide() } else { if (e.keyCode == 32 && !vars.hover_pause) { clearInterval(vars.slideshow_interval); d.playToggle() } }
                    }
                })
            }
