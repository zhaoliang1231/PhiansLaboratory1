<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LosslessReport_Issue.aspx.cs" Inherits="phians.mainform.Lossless_report.LosslessReport_Issue" %>
...
<head runat="server">
    ...
    <%--    <%= WebExtensions.CombresLink("Report_Procedure_Issue_Js") %>
...
<body>
    ...
    <%-- 阅读文件隐藏按钮doc --%>
    <a href="<%=PageOffice.PageOfficeLink.OpenWindow("/mainform/Revisionsshow.aspx?save_type=Lossless_report_1&ReturnNode=IssueUpdate&","width=1000px;height=740px;")%>" id="Revision_doc" class="easyui-linkbutton" data-options="iconCls:'icon-read',plain:true"><span id="read_doc_">阅读</span>></a>
    <a href="<%=PageOffice.PageOfficeLink.OpenWindow("/mainform/Revisionsshow.aspx?save_type=Lossless_report_1&ReturnNode=IssueUpdate&","width=1000px;height=740px;")%>" id="read_doc" class="easyui-linkbutton" data-options="iconCls:'icon-read',plain:true"><span id="read_doc_">阅读</span>></a>
</body>
<%=WebExtensions.CombresLink("LosslessReport_Issue_Js") %>
</html>
